      ...
      <header className="fixed top-0 w-full bg-white/95 backdrop-blur-md border-b border-slate-100 z-50">
        <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
          <Link href="/" className="relative w-48 h-14 block">
            {/* Мы увеличили w-32 -> w-56 и h-10 -> h-14, а также h-20 в шапке на h-24 */}
            <Image 
              src="/Dokki.logo.png" 
              alt="Dokki Logo" 
              fill 
          ...
          <div className="flex gap-4">
            <a href="mailto:hi@dokki.org" className="bg-slate-900 text-white px-8 py-3 rounded-xl text-xs font-black hover:shadow-xl transition-all tracking-widest">
              CONTACT
            </a>
          </div>
        </div>
